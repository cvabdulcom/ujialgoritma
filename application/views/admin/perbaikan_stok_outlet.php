        ...
        <div class="box box-primary">
          <div class="box-body chart-responsive">
            ...
            <div class="col-md-5 form-horizontal">
              <div class="form-group">
                <label for="tempo" class="col-sm-4 control-label">No Action</label>
                <div class="col-sm-8">
                  <input type="text" class="form-control" name="no_actiontracking" id="no_actiontracking" disabled="disabled">  
                </div>
              </div>
              <div class="form-group">
  ...
  $(document).ready(function(){
    ...
    $('input:radio[name="status_perubahan"]').change(
      function(){
        if (this.checked) {
          ...
          $('#no_actiontracking').attr('disabled', false);
          $('#no_actiontracking').focus();
        }
      }
    );
    ...
    $('.add').click(function(){
      ...
      if (status_perubahan_cek == 'penambahan') {
        ...
        var no_surat_jalan_add = $("#no_actiontracking").val();
    ...
    function Simpan_stok_outlet(){
      $.ajax({
        ...
        success: function(data){
            swal({
            title: "Perbaikan Stok Outlet Disimpan !",
            type: "success",
            confirmButtonColor: "#2C3FF9",
            showCancelButton: false,
            confirmButtonText: "OK",
