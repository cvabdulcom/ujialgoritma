      ...
      <div class="col-md-12">
        ...
        <div class="nav-tabs-custom">
          <ul class="nav nav-tabs">
            <li class="active"><a href="<?php echo base_url('laporan/kas'); ?>">Laporan Kas</a></li>
            <li><a href="<?php echo base_url('laporan/kas_keluar'); ?>">Uang Keluar</a></li>
            <li class="pull-right">
                ...
                <div class="form-group">
                  <div class="input-group col-md-3">
                    ...
                    <span class="input-group-btn">
                      <form method="get" action="<?php echo base_url('laporan/kas_search'); ?>">
                    ...
                    <table id="example2" class="table table-bordered table-hover">
                      <thead>
                        <tr class="bg-info">
                          ...
                          <th class="text-center" rowspan="2">Total Uang Masuk</th>
                          <th class="text-center" rowspan="2">Total Uang Keluar</th>
                          <th class="text-center" rowspan="2">Selisih Hari Ini</th>
                          <th class="text-center" colspan="2">Setoran</th>                          
                          <th class="text-center" rowspan="2"></th>
                        </tr>
                        <tr class="bg-info">
                          <th class="text-center">Saldo Kas</th>
                      ...
                      <tbody>
                        <?php
                          $no=0;
                          foreach($kas->result_array() as $tampil):
                            $no++;
                          ...
                          <td class="text-center">
                            <?php
                              $hitung2 = $this->db->query("SELECT SUM(nominal) AS nominal 
                                ...
                                WHERE tipe='Keluar'
                                AND tanggal='$tanggal'");
                              $total_uang_keluar = $hitung2->row()->nominal;
                              echo number_format($total_uang_keluar, 0, ',', '.');
                            ?>
                          </td>
                          <td class="text-center">
                            <?php
                              $selisih_hari_ini = $total_uang_masuk - $total_uang_keluar;
                              echo number_format($selisih_hari_ini, 0, ',', '.');
                            ?>
                          </td>
                          <td class="text-center">
                            <?php
                              ...
                              echo number_format($saldo_kas, 0, ',', '.');
                            ?>
                          </td>
                          <td class="text-center">
                            <?php
                              ...
                              echo number_format($saldo_bank, 0, ',', '.');
                            ?>
                          </td>
                          <td class="text-left">
                            <button class="btn btn-xs btn-info" data-toggle="modal" data-target="#LIHAT<?php echo $tanggal; ?>"><i class="fa fa-expand"></i></button>
                            <!-- Expand -->
                            <div class="modal fade bd-example-modal-lg" id="LIHAT<?php echo $tanggal; ?>">
                              <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                  <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                  ...
                                  <div class="modal-body table-responsive">
                                    <table id="example2" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                                      <thead>
                                        <tr role="row">
                                          <th class="sorting_1" width="10" style="text-align: center;">No</th>
                                          <th class="sorting" style="text-align: center;">ID Kas</th>
                                          <th class="sorting" style="text-align: center;">Tanggal</th>
                                      ...
                                      <tbody>
                                        <?php
                                          $cek_detail = $this->db->query("SELECT * FROM tbl_kas_1 WHERE tanggal='$tanggal'");
                                            $no_detail=0;
                                        ...
                                        <tr>
                                          ...
                                          <td class="text-center"><?php echo $id_kas_detail; ?></td>
                ...
                <div class="box-footer">
                  ...
                  <div class="btn-group pull-right">
                    ...
                    <ul class="dropdown-menu" role="menu">
                      <li><a href="<?php echo base_url('export/kas_1'); ?>">Download Kas 1</a></li>
                      <li><a href="<?php echo base_url('export/kas_2'); ?>">Download Kas 2</a></li>
                    </ul>
                  </div>
                </div>
              </div>
