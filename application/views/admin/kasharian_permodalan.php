    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class="active treeview menu-open">
        ...
        <ul class="treeview-menu">
          ...
          <li class="active"><a href="<?php echo base_url('kasharian/permodalan'); ?>"><i class="fa fa-circle-o"></i> Permodalan</a></li>
        ...
        <div class="box box-primary">
          <div class="box-body chart-responsive">
            <div class="col-md-6 form-horizontal">
              ...
              <div class="form-group">
                <label for="no_nota" class="col-sm-4 control-label">Tipe</label>
                <div class="col-sm-8">
                  <select class="form-control" name="tipe" id="tipe" style="width: 100%;" disabled="disabled">
            ...
            <input type="hidden" name="tujuan" id="tujuan" value="Permodalan">
            <input type="hidden" name="account_transaksi" id="account_transaksi" value="Modal">
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    function kas(){
      ...
      var account_transaksi = $("#account_transaksi").val();
      var tipe = $("#tipe").val();
      var jenis = $("#jenis").val();
