            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                <thead>
                  ...
                  <?php
                    $no=0;
                    foreach($rekap->result_array() as $tampil):
                      $no++;
                  ...
                  <tr>
                    ...
                    <td align='center' width="30">
                      <a href="https://drive.google.com/file/d/<?php echo $foto_kontrak_tempo; ?>/view" target="_blank">
                        <i class="fa fa-file-archive-o"></i>
                      </a>
                    </td>
                    <td align='center' width="30">
                      <form method="POST" action="<?php echo base_url('jualputus/Simpan_approve2'); ?>">
                        <input type="hidden" name="id_outlet" value="<?php echo $id_outlet; ?>">
                        <button type="submit" class="btn btn-xs btn-success"><i class="fa fa-check-square-o"></i></button>
                      </form>
                    </td>
                  </tr>
                  <?php endforeach; ?>
