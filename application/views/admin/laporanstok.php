          ...
          <ul class="nav nav-tabs">
            ...
            <li class="pull-right">
              <div class="text-center">
                <a href="<?php echo base_url('laporan/so_sistem'); ?>" class="btn btn-default btn-xs"><i class="fa fa-home"></i> SO Sistem</a>
                ...
                <a class="btn btn-success btn-xs active" href="<?php echo base_url('laporan/stok'); ?>"><i class="fa fa-bitbucket"></i> Pcs</a>
                <a class="btn btn-default btn-xs" href="<?php echo base_url('laporan/stok_dus'); ?>"><i class="fa fa-dropbox"></i> Dus</a>
              </div>
            </li>
          </ul>
