      ...
      <div class="col-xs-12">
        <div class="box">
          ...
          <div class="box-body table-responsive">
            <form method="POST" action="<?php echo base_url('hargaproduk/cetak_pricelist'); ?>" target="_blank">
              <div class="form-group">
                <div class="input-group col-md-3">
                  <span class="input-group-btn">
                    <button type="submit" class="btn btn-primary btn-sm btn-flat" id="button_search"><i class="fa fa-print"></i> Cetak Pricelist</button>
                  </span>
                </div>
              </div>
            </form>
