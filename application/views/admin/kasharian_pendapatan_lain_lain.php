    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class="active treeview menu-open">
        ...
        <ul class="treeview-menu">
          ...
          <li class="active"><a href="<?php echo base_url('kasharian/pendapatan_lain_lain'); ?>"><i class="fa fa-circle-o"></i> Pendapatan Lain-lain</a></li>
...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      <b>Kas Harian</b>
      <small>Pendapatan Lain-lain</small>
    </h1>
    <ol class="breadcrumb">
      ...
      <div class="col-md-12">
        <div class="box box-primary">
          <div class="box-body chart-responsive">
            ...
            <input type="hidden" name="tujuan" id="tujuan" value="Pendapatan Lain-lain">
