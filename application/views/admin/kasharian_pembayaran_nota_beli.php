    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class="active treeview menu-open">
        ...
        <ul class="treeview-menu">
          ...
          <li class="active"><a href="<?php echo base_url('kasharian/pembayaran_nota_beli'); ?>"><i class="fa fa-circle-o"></i> Pembayaran Nota Beli</a></li>
...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      <b>Kas Harian</b>
      <small>Pembayaran Nota Beli</small>
    </h1>
    <ol class="breadcrumb">
      ...
      <div class="col-md-12">
        <div class="box box-primary">
          <div class="box-body chart-responsive">
            ...
            <input type="hidden" name="tujuan" id="tujuan" value="Pembayaran Nota Beli">
          ...
          <table id="daftarceknota" class="table table-bordered dataTable">
            <thead>
              <tr role="row">
                ...
                <th class="sorting" aria-controls="example1" style="text-align: center;">Nama Supplier</th>
            ...
            <tbody id="show_cek_nota">
              ...
              <tr>
                ...
                <td><button class="cek_no_nota btn btn-xs btn-flat btn-default" data-nota="<?php echo $no_nota_pembelian; ?>" data-supplier="<?php echo $supplier; ?>"><i class="fa fa-plus"></i></button></td>
              </tr>
              <?php endforeach; ?>
            </tbody>
          </table>
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    function Tarik_nota(){
      ...
      $.ajax({
        type      : "GET",
        url       : "<?php echo base_url('kasharian/tarik_nota_pembelian'); ?>",
        dataType  : "JSON",
    ...
    function kas(){
      ...
      var account_transaksi = $("#supplier").val();
      var tipe = $("#tipe").val();
      var jenis = $("#jenis").val();
    ...
    function lunas(){
      ...
      $.ajax({
        type      : "POST",
        url       : "<?php echo base_url('kasharian/update_pembelian'); ?>",
        dataType  : "JSON",
        data      : {no_nota_pembelian: no_nota_pembelian},
        success   : function(data){
          swal({
