      ...
      <li class="active treeview menu-open">
        ...
        <ul class="treeview-menu">
          ...
          <li class="active treeview menu-open">
            ...
            <ul class="treeview-menu">
              <li class="active"><a href="<?php echo base_url('outletmasuk/gb_rekap'); ?>"><i class="fa fa-circle-o"></i> Rekap</a></li>
            </ul>
          </li>
        </ul>
      </li>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td align='center' width="30">
                      <form method="POST" action="<?php echo base_url('profiling/cetak'); ?>" target="_blank">
                        <input type="hidden" name="id_outlet" value="<?php echo $id_outlet; ?>">
                      <button type="submit" class="btn btn-xs btn-default"><i class="fa fa-eye"></i></button>
                      </form>
                    </td>
                  </tr>
                  <?php endforeach; ?>
