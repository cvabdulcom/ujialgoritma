              ...
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td align='center' width="60">
                      <a href="https://drive.google.com/file/d/<?php echo $foto_stokawal; ?>/view" target="_blank">
                        <i class="fa fa-file-archive-o"></i>
                      </a>
                    </td>
                    <td align='center' width="30">
                      <form method="POST" action="<?php echo base_url('konsinyasi/Simpan_approve'); ?>">
