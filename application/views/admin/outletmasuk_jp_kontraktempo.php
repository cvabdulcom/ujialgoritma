      ...
      <li class="active treeview menu-open">
        ...
        <ul class="treeview-menu">
          <li class="active treeview menu-open">
            ...
            <ul class="treeview-menu">
              <li class="active"><a href="<?php echo base_url('outletmasuk/jp_filekontraktempo'); ?>"><i class="fa fa-circle-o"></i> File Kontrak Tempo</a></li>
            </ul>
          </li>
          <li class="treeview">
...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Outlet Masuk
        <small>Jual Putus (File Kontrak Tempo)</small>
      </h1>
      <ol class="breadcrumb">
          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <thead>
                ...
                <?php
                  $no=0;
                  foreach($kontraktempo->result_array() as $tampil):
                    $no++;
    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <form method="POST" action="<?php echo base_url('jualputus/simpan_filekontraktempo'); ?>">
