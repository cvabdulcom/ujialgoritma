            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tbody>
                  <?php
                    $no=0;
                    foreach($stokawal->result_array() as $tampil):
                      $no++;
                  ...
                  <tr>
                    ...
                    <td align='center' width="30">
                      <a href="https://drive.google.com/file/d/<?php echo $foto_kontrak; ?>/view" target="_blank">
                        <button class="btn btn-xs btn-warning"><i class="fa fa-file-archive-o"></i></button>
                      </a>
                    </td>
                    <td align='center' width="30">
                      <button class="btn btn-xs btn-primary item_upload" data="<?php echo $id_outlet; ?>"><i class="fa fa-upload"></i></button>
                    </td>
                  </tr>
                  <?php endforeach; ?>
                </tbody>
    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <form method="POST" action="<?php echo base_url('Konsinyasi/Simpan_filestokawal'); ?>">
