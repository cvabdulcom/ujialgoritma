    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class="active treeview menu-open">
        ...
        <ul class="treeview-menu">
          ...
          <li class="active"><a href="<?php echo base_url('hapusdata/datakas'); ?>"><i class="fa fa-circle-o"></i> Data Kas</a></li>
          ...
          <div class="box-footer">
            ...
            <div class="input-group pull-right form-horizontal col-md-3">
              ...
              <span class="input-group-btn">
                <form method="get" action="<?php echo base_url('hapusdata/datakas'); ?>">
            ...
            <table id="example2" class="table table-bordered table-striped dataTable">
              <thead>
                <tr>
                  ...
                  <th class="text-center">Account Transaksi</th>
              ...
              <tbody>
                <?php
                  $no=0;
                  foreach($datakas->result_array() as $tampil):
                    $no++;
                ...
                <tr>                  
                  ...
                  <td class="text-left"><?php echo $tujuan; ?></td>
                  ...
                  <td class="text-center"><?php echo number_format($nominal, 0, ',', '.'); ?></td>
                  ...
                  <td class="text-left">
                    ...
                    <!-- /.modal -->
                    <form method="POST" action="<?php echo base_url('hapusdata/hapus_kasharian'); ?>">
                      <div class="modal fade bd-example-modal-sm" id="HAPUS<?php echo $id_kas; ?>">
                        <div class="modal-dialog modal-sm">
                          <div class="modal-content">
                            <div class="modal-body">
                              Anda yakin hapus Kas <strong><?php echo $id_kas; ?></strong> ?
                            </div>
                            <div class="modal-footer">
                              <input type="hidden" name="id_kas" value="<?php echo $id_kas; ?>">
                              <input type="hidden" name="tanggal" value="<?php echo $tanggal; ?>">
                              <input type="hidden" name="account_transaksi" value="<?php echo $account_transaksi; ?>">
