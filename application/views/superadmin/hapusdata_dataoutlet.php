    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class="active treeview menu-open">
        ...
        <ul class="treeview-menu">
          ...
          <li class="active"><a href="<?php echo base_url('hapusdata/dataoutlet'); ?>"><i class="fa fa-circle-o"></i> Data Outlet</a></li>
            ...
            <table id="example2" class="table table-bordered table-striped dataTable">
              <thead>
                <tr>
                  ...
                  <th class="text-center">Kecamatan/Kabupaten</th>
              ...
              <tbody>
                <?php
                  $no=0;
                  foreach($dataoutlet->result_array() as $tampil):
                    $no++;
                ...
                <tr>                  
                  ...
                  <td class="text-left"><?php $new = strtotime($tanggal_lahir); $newDate = date('d/m/Y', $new);  echo $newDate; ?></td>
                  <td class="text-left"><?php echo $alamat; ?></td>                  
                  <td class="text-left"><?php echo $kecamatan; ?>/<?php echo $kabupaten; ?></td>
                  <td class="text-center"><?php echo $nama_salesman; ?></td>
                  <td class="text-center"><?php echo $tipe_pembelian; ?></td>
                  ...
                  <td class="text-left" width="30">
                    ...
                    <!-- /.modal -->
                    <form method="POST" action="<?php echo base_url('hapusdata/hapus_dataoutlet'); ?>">
                      <div class="modal fade bd-example-modal-sm" id="HAPUS<?php echo $id_outlet; ?>">
                        <div class="modal-dialog modal-sm">
                          <div class="modal-content">
                            <div class="modal-body">
                              Hapus Data Outlet <strong><?php echo $nama_outlet; ?></strong> ?
                            </div>
