    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class="active treeview menu-open">
        ...
        <ul class="treeview-menu">
          ...
          <li class="active"><a href="<?php echo base_url('hapusdata/pembelian'); ?>"><i class="fa fa-circle-o"></i> Pembelian</a></li>
          ...
          <div class="box-footer">
            ...
            <div class="input-group pull-right form-horizontal col-md-3">
              ...
              <span class="input-group-btn">
                <form method="get" action="<?php echo base_url('hapusdata/pembelian'); ?>">
            ...
            <table id="example2" class="table table-bordered table-striped dataTable">
              <thead>
                <tr>
                  ...
                  <th class="text-center">Nota Pembelian</th>
              ...
              <tbody>
                <?php
                  $no=0;
                  foreach($pembelian->result_array() as $tampil):
                    $no++;
                ...
                <tr>                  
                  ...
                  <td class="text-left"><?php echo $no_nota_pembelian; ?></td>
                  ...
                  <td class="text-left"><?php echo $nama_admin; ?></td>
                  <td class="text-left" width="30">
                    <button class="btn btn-danger btn-xs" data-toggle="modal" data-target="#HAPUS<?php echo $no_nota_pembelian; ?>">Hapus</button>  
                    <!-- /.modal -->
                    <form method="POST" action="<?php echo base_url('hapusdata/hapus_pembelian'); ?>">
                      <div class="modal fade bd-example-modal-sm" id="HAPUS<?php echo $no_nota_pembelian; ?>">
                        <div class="modal-dialog modal-sm">
                          <div class="modal-content">
                            <div class="modal-body">
                              Hapus Nota Pembelian <strong><?php echo $no_nota_pembelian; ?></strong> ?
                            </div>
